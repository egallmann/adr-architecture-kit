...
from ..models.v1_3 import (
    LogicalADRv13,
    PhysicalADRv13,
    PhysicalComponentADRv13,
    PhysicalSystemADRv13,
)
from ..models.v1_4 import (
    LogicalADRv14,
    PhysicalADRv14,
...
class ADRParser:
    ...
    def _load_schemas(self):
        ...
        schema_v13_files = {
            "types_v1_3": "types.schema.json",
            "common_v1_3": "adr-common.schema.json",
            "logical_v1_3": "adr-logical.schema.json",
            "physical_v1_3": "adr-physical.schema.json",
            "physical_base_v1_3": "adr-physical-base.schema.json",
            "physical_system_v1_3": "adr-physical-system.schema.json",
            "physical_component_v1_3": "adr-physical-component.schema.json",
        }

        schema_v14_files = {
            "types_v1_4": "types.schema.json",
            "common_v1_4": "adr-common.schema.json",
            "logical_v1_4": "adr-logical.schema.json",
            "physical_v1_4": "adr-physical.schema.json",
            "physical_base_v1_4": "adr-physical-base.schema.json",
            "physical_system_v1_4": "adr-physical-system.schema.json",
        ...
        schema_authoring_v16_files = {
            "types_v1_6": "types.schema.json",
            "common_v1_6": "adr-common.schema.json",
            "logical_v1_6": "adr-logical.schema.json",
            "physical_base_v1_6": "adr-physical-base.schema.json",
        ...
        schema_v21_files = {
            "normalized_entity_registry_v2_1": "normalized-entity-registry.schema.json",
            "relationship_registry_v2_1": "relationship-registry.schema.json",
            "unresolved_registry_v2_1": "unresolved-registry.schema.json",
        ...
        schema_v23_files = {
            "normalized_entity_registry_v2_3": "normalized-entity-registry.schema.json",
            "relationship_registry_v2_3": "relationship-registry.schema.json",
            "unresolved_registry_v2_3": "unresolved-registry.schema.json",
        ...
        for name, filename in schema_v14_files.items():
            schema_path = self.schema_v14_dir / filename
            if schema_path.exists():
                with open(schema_path) as f:
                    self._schemas[name] = json.load(f)
    ...
    def parse_physical_adr(self, file_path: Union[str, Path]) -> PhysicalADR:
        ...
        try:
            if data.get("schema_version") == "1.4":
                return cast(PhysicalADR, PhysicalADRv14(**data))
            if data.get("schema_version") == "1.3":
                return cast(PhysicalADR, PhysicalADRv13(**data))
    ...
    def parse_physical_component_adr(self, file_path: Union[str, Path]) -> PhysicalComponentADR:
        ...
        try:
            ...
            if data.get("schema_version") == "1.3":
                return cast(PhysicalComponentADR, PhysicalComponentADRv13(**data))
