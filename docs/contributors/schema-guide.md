...
- [`logical-adr-guide.md`](logical-adr-guide.md) — writing logical ADRs
- [`physical-adr-guide.md`](physical-adr-guide.md) — writing physical ADRs
- [`graph-integration.md`](graph-integration.md) — ste-runtime integration
- [`../docs/architecture-ir-overview.md`](../docs/architecture-ir-overview.md) — public IR layers (curated `docs/`)
