"""Physical-system ADR authoring v1.6."""
...
from ..v1_5.physical_system_adr import PhysicalSystemADRv15
from .normative_proposition import NormativePropositionV16


@implements_adr("ADR-L-0001", "ADR-L-0028")
class PhysicalSystemADRv16(PhysicalSystemADRv15):
    ...
    def require_unique_normative_proposition_identity(self) -> "PhysicalSystemADRv16":
