...
└── ../ste-spec/            # Sibling STE specification workspace folder
```
...
The full specification is available in the sibling workspace folder: [../ste-spec/ste-spec](../ste-spec/ste-spec/)
