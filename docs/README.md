...
| `physical-adr-guide.md` | Add under `contributors/` if you still need it; not linked from the public index |
| `schema-guide.md` | Prefer [schema/v1.0/README.md](../schema/v1.0/README.md); long-form guide optional under `contributors/` |
