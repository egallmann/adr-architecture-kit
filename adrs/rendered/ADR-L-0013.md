...
source_hash: e3916a6f6a5823f03432c9242c1b5d68ef1f3a8599a9e4341e23dfc8a71cbf46
rendered_hash: f357e5f74d2cd65c07ffd3ac1c3a9d38e23025299ceb96291a8ba60424704e1b
-->
...
**Related ADRs:** ADR-L-0009, ADR-L-0010, ADR-L-0012, ADR-L-0018, ADR-PC-0005, ADR-PC-0001
...
Provide one scope-safe, deterministic in-process interface that loads compiled architecture bundles and returns NormalizedArchitectureModel 2.0 with UUID, alias, and logical URI resolution.
...
### DEC-0051: Expose NormalizedArchitectureModel 2.0 as the repository semantic payload carrying UUID/alias/type/URI/time/fingerprint semantics
...
V1.3 advances the normalized semantic model to model 2.0 with UUID IDs/endpoints, explicit UUID/alias lookups, and versioned compatibility adapters.
