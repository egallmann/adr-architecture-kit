...
rendered_hash: a2b695544887765171cab66cf0c5c523748d6279784a31ee54fbcb51a1f3fda6
-->
...
**Domains:** architecture, authoring, semantic-authority, schema-governance, extensibility, identity, topology, consumer-bindings<br>
**Tags:** semantic-authoring, construction, detached-candidate, authority-boundary, successor-contracts, r1-design-lock<br>
...
domain meaning. The round-trip path follows ADR-L-0030: explicit construction
intent produces a detached candidate semantic/artifact result, whose exact
candidate artifact bytes or qualified sources form an Exact Source Basis for
canonical Rust semantic execution and a canonical normalized semantic result;
semantic-equivalence comparison is required before Constructed.
...
Reconciliation with ADR-L-0030 is intentionally limited to the Constructed
round-trip boundary above. Construction does not create a second
construction-specific semantic interpreter: candidate bytes or qualified
sources enter the Exact Source Basis and canonical Rust execution path
established by ADR-L-0030.
